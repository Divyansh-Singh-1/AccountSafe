...
import { MagicCard, BorderBeam } from '../../../components/ui';
...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <MagicCard
      ref={cardRef}
      className="p-0 rounded-xl relative sm:overflow-hidden overflow-visible group transition-all"
    >
      {isPinned && <BorderBeam duration={6} size={160} />}
      {/* Card Header */}
      <div className="border-b border-zinc-200 dark:border-zinc-800/50 bg-zinc-50/50 dark:bg-zinc-900/30 rounded-t-xl overflow-visible">
        <div className="py-2.5 sm:px-4 sm:py-3 -mt-2 sm:mt-0 flex items-center justify-between gap-2 rounded-t-xl">
